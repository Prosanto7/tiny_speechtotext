...
/**
 * Tiny Speech to Text plugin for Moodle.
 *
 * @module      tiny_speechtotext/plugin
 * @copyright   2026
...
// Setup the Speech to Text Plugin.
...
export default new Promise(async(resolve) => {
    ...
    // Resolve the Speech to Text Plugin and include configuration.
